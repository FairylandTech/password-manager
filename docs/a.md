...
> @since: 2024-06-14 上午10:18:33 UTC+8
...
```powershell
pip install --no-cache-dir pip-tools pipreqs flake8 isort black mypy pydocstyle pylint autopep8 pylama pigar pipdeptree
```
